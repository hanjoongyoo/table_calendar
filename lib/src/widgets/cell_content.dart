...
class CellContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final text = isToday ? calendarStyle.todayText ?? dayString : dayString;
    ...
    if (isDisabled) {
      ...
      cell = calendarBuilders.todayBuilder?.call(context, day, focusedDay) ??
          AnimatedContainer(
            ...
            child: Text(
              text,
              style: isSelected
                  ? calendarStyle.todaySelectedTextStyle
      ...
      cell = calendarBuilders.selectedBuilder?.call(context, day, focusedDay) ??
          AnimatedContainer(
            ...
            margin: margin,
            padding: padding,
            decoration: day.day == focusedDay.day
                ? calendarStyle.focusedDecoration
                : calendarStyle.selectedDecoration,
            alignment: alignment,
      ...
      cell = calendarBuilders.defaultBuilder?.call(context, day, focusedDay) ??
          AnimatedContainer(
            ...
            padding: padding,
            decoration:
                isWeekend ? calendarStyle.weekendDecoration : calendarStyle.defaultDecoration,
            alignment: alignment,
            child: Text(
              text,
